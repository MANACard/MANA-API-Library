...
namespace Mana.Cards.Client
{
    partial class SalesForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rpAddClient = new Mana.Cards.Client.CostumControls.RoundedPanel();
            ...
            this.txtRedeemValue = new Mana.Cards.Client.CostumControls.RoundedTextBox();
            this.roundedPanel6 = new Mana.Cards.Client.CostumControls.RoundedPanel();
            this.txtRedeemPoints = new Mana.Cards.Client.CostumControls.RoundedTextBox();
            this.roundedPanel5 = new Mana.Cards.Client.CostumControls.RoundedPanel();
            this.txtAvailablePoints = new Mana.Cards.Client.CostumControls.RoundedTextBox();
            this.roundedPanel4 = new Mana.Cards.Client.CostumControls.RoundedPanel();
            this.txtClientName = new Mana.Cards.Client.CostumControls.RoundedTextBox();
